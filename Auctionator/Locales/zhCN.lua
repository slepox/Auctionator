...
.."扫描拍卖场会建立价格资料库，用于两种途径："
.."<br/>"
.."1.在鼠标提示中显示价格"
.."<br/>"
.."2.在你建立拍卖，场上无其他拍卖品的时候显示建议价格。"
.."<br/><br/>"
.."扫描通常需要约10秒，但有时需要更久的时间。"
.."<br/><br/>"
...
AtrL["Auction House timed out"] = "拍卖过期"
AtrL["Auction"] = "拍卖"
AtrL["Auctionator has yet to record any auctions for this item"] = "尚无此物品记录"
AtrL["Auctionator memory usage:"] = "Auctionator 内存用量"
AtrL["Auctionator provided an auction module to LilSparky's Workshop."] = "Auctionator为LilSparky工作室提供拍卖插件。"
...
AtrL["available"] = "可用"
AtrL["average of your auctions for"] = "你的拍卖平均价"
AtrL["Back"] = "返回"
...
AtrL["Common"] = "普通"
AtrL["Configure how you typically like to sell the items listed below."]="设定如下物品的一般卖出选择"
AtrL["Continue"] = "继续"
...
AtrL["Date"] = "日期"
AtrL["days"]="天"
AtrL["Default Auctionator tab"] = "默认Auctionator页面"
AtrL["default behavior"] = "默认行为"
...
AtrL["full scan database cleared"] = "扫描资料库已清除"
AtrL["Full Scan..."] = "扫描..."
...
AtrL["Herbs"] = "草药"
AtrL["History"] = "纪录"
AtrL["If this option is checked, ALL your bags will be opened when you first open the Auctionator panel."]="若勾选此选项，打开Auctionator页面时将同时打开你全部背包"
AtrL["If this option is checked, every time you initiate a new auction the auction duration will be reset to the default duration you've selected."]="若勾选此选项，每当你摆放拍卖物品时，将自动设定有效期限为默认值。"
...
AtrL["If this option is checked, the Auctionator BUY panel will display first whenever you open the Auction House window."]="若勾选此选项，打开拍卖场时Auctionator购买页面将总是位于第一页。"
AtrL["Ignore any ERROR message to the contrary below."] = ""
AtrL["in about %d minutes"] = "约%d分钟后"
AtrL["in about one minute"] = "约1分钟后"
AtrL["in less than a minute"] = "不到一分钟"
AtrL["Item Enhancements"] = "物品附魔"
AtrL["Item Name"] = "物品"
AtrL["Item Price"] = "单价"
AtrL["Items added to database"] = "物品新增到资料库"
AtrL["Items added:"] = "新增物品:"
AtrL["Items ignored"] = "忽略物品"
AtrL["Items ignored:"] = "忽略物品"
AtrL["Items in database:"] = "资料库中物品:"
AtrL["Items in the database:"] = "资料库中物品:"
AtrL["Items updated in database"] = "资料库物品已更新"
...
AtrL["Only include items in the scanning database that are this level or higher"] = "资料库中只包含高于此品质的物品"
AtrL["Options"] = "设定"
AtrL["Other"] = "其他"
...
AtrL["removed from database"] = "'从资料库中移除"
...
AtrL["Select the Auctionator panel to be displayed first whenever you open the Auction House window."]="选择当你进入拍卖行时打开的页面"
AtrL["Sell"] = "卖出"
AtrL["Selling"] = "卖出"
